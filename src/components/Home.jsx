...
const HomeImg = () => {
  ...
  return (
    <div className="home-div">
        ...
        <p className="home-para">I build practical, polished software across frontend and backend systems, with growing focus on React Native mobile apps. My toolkit includes React, Redux, JavaScript, Ruby on Rails, Node, SQL, Tailwind CSS, and the mobile ecosystem I am actively learning: React Native, Expo, React Navigation, and NativeWind. I like clean code, useful interfaces, and bugs that leave quietly after one strongly worded console log.
        </p> 
