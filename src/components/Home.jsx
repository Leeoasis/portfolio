...
const HomeImg = () => {
  ...
  return (
    <div className="home-div">
        ...
        <p className="home-para">I build practical, polished software across frontend and backend systems, with growing focus on React Native mobile apps. My toolkit includes React, Redux, JavaScript, Ruby on Rails, Node, SQL, Tailwind CSS, and WordPress, from custom template development in Local to polished builds using WordPress templates. I like clean code, useful interfaces, and bugs that leave quietly after one strongly worded console log.
        </p> 
